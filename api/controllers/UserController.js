/*
-------------------- USER CONTROLLER --------------------
Controlador do usuarios

Metodos:
    login: para logar
    create_user: criar usuario
    delete_user: deleta usuario
    get_data: recebe dados
    alter_data: altera dados
    alter_password: altera password
    find_user: encontra um usuario a partir de um nome
    find_user_using_string: encontra usuarios a partir de parte do nome
    get_groups: busca os grupos de um usuario
*/
